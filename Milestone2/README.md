...
| Secret | Purpose |
|---|---|
| `JWT_SECRET_KEY` | Signs & verifies login session tokens — any long random string |
...
| `EMAIL_ID` | Gmail address that sends OTP/alert emails (optional — console fallback works without it) |
